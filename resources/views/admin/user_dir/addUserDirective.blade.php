@section('title', 'Add User Directive Template')
			...
			<div class="row">
				<div class="col-md-6">
					<div class="page-tital"> 
						<h2> Add User Directive Template : </h2>
			...
			else
			{
				...
				$.ajax({
					...
					{						
						...
						$('#resp').html();
						$('#resp').html('User Directive added successfully.');
						
						window.location.href = "<?php echo URL::to('admin/user-directive'); ?>";	
