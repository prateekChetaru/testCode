@section('title', 'Edit User Pre-Config Directive')
						...
						<div class="row">
							...
							<div class="col-md-12 directive-box">
								...
								<div class="edit-filed-icon">
									<a href="{{URL::to('admin\user-directive-form-option-edit\/').base64_encode($questionId)}}">
										<i class="fa fa-pencil" aria-hidden="true"></i></a>
										<a href="{{URL::to('admin/delete\/').base64_encode('udr_questions').'/'.base64_encode($questionId)}}" onclick="return confirm('Are you sure you want to delete.');">
			...
			function initializeFormBuilder() {
				...
				document.getElementById('getJSON').addEventListener('click', function() {
					...
					if(formArray.length <=2){
						...
						window.location.href = "<?php echo route('user-directive-configured'); ?>";	
					}
					else
					{
						...
						$.ajax({
							type: "POST",					
							url: "{{URL::to('admin/user-directive-configured-add-new-inputs')}}",				
