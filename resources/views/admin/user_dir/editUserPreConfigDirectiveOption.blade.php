@section('title', 'Edit User Directive Option')
...
<main class="main-content">
	...
	<div class="ragistration-detele add-fild-section">
		<div class="container">
			<div class="row">
				<div class="col-md-12">
					<form id="" action="{{URL::to('admin/update-user-directive-question')}}" method="post">
									...
									<li>
										<div class="form-group input-area">
											...
											<div class="add_delete pull-right">
												...
												<a href="{{URL::to('admin/delete\/').base64_encode('udr_form_option_choices').'/'.base64_encode($cValue->id)}}"><i class="fa fa-trash" aria-hidden="true"></i></a>
						...
						@if(Request::segment(2)=='user-directive-form-option-edit')

						<a href="{{route('user-directive.edit',['id'=>base64_encode($qValue->form_id)])}}"><button type="button" onclick="" class="btn save"> BACK </button></a>

						@else

						<a href=""><button type="button" onclick="" class="btn save"> BACK </button></a>
