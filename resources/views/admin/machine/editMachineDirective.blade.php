@section('title', 'Make copy Machine Directive')
								...
								<div class="form-group">
									...
									<input type="text" class="form-control validate" name="texta[]" value="">
											...
											@endif()
												...
												<a href="{{URL::to('admin\directive-option-edit\/').base64_encode($questionId)}}">
					...
					function initializeFormBuilder() {
						...
						document.getElementById('getJSON').addEventListener('click', function() {
							...
							if(formArray.length <=2){
								...
								window.location.href = "<?php echo route('machine-directive.index'); ?>";	
							}
							else
							{
